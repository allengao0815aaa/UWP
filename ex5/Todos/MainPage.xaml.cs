...
namespace Todos
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            init();
            ViewModel.AddTodoItem("first", "Hello!", DateTime.Today, myPicture.Source, currentfile);
            ViewModel.AddTodoItem("second", "Nice to meet you!", DateTime.Today, myPicture.Source, currentfile);
        ...
        private void CreateButton_Clicked(object sender, RoutedEventArgs e)
        {
            if (ok())
            {
                ViewModel.AddTodoItem(title.Text, description.Text, DueDate.Date, myPicture.Source, currentfile);
